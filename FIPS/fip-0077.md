...
To combat spamming, a deposit reflecting the opportunity cost is proposed for each new miner actor creation, detailed as follows:
### Deposit Amount Calculation:
The deposit amount will be based on a waterline storage deposit of 10t, defined in the existing MINIMUM_CONSENSUS_POWER constant.
This base amount will be multiplied by the sealing cost pledge, approximately 5.5 FIL/t as of 3/16/2024, as determined by existing function StateMinerInitialPledgeCollateral. This reflects the economic conditions of the network.

### Vesting Schedule:

Deposited funds will adhere to the existing vesting schedule, being locked as rewards for 180 days. This represents the opportunity cost and ensures that the funds are temporarily inaccessible.
